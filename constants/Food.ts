...
export const restaurants: Restaurant[] = [
  {
    ...
    address_en: 'No. 267, Section 2, Gongdao 5th Rd, East District, Hsinchu City 300',
    address_zh: '300新竹市東區公道五路二段267號',
  ...
  },
  {
    ...
    address_en: "No. 13, Alley 26, Lane 300, Section 4, Ren'ai Rd, Da'an District, Taipei City 106",
    address_zh: '106台北市大安區仁愛路四段300巷26弄13號',
  ...
  },
  {
    ...
    address_en: 'No. 87, Section 4, Tingzhou Rd, Wenshan District, Taipei City',
    address_zh: '台北市文山區汀州路四段87號',
  ...
  },
  {
    ...
    address_en: 'No. 410-1, Section 1, Dongshan Rd, Beitun District, Taichung City 406',
    address_zh: '406台中市北屯區東山路一段410-1號',
  ...
  },
  {
    ...
    address_en: "No. 6, Lane 151, Section 2, Jianguo S Rd, Da'an District, Taipei City",
    address_zh: '台北市大安區建國南路二段151巷6號',
  ...
  },
  {
    ...
    address_en: "No. 100, Section 4, Zhongxiao E Rd, Da'an District, Taipei City",
    address_zh: '台北市大安區忠孝東路四段100號',
  ...
  },
  {
    ...
    address_en: 'No. 200, Section 1, Zhongshan Rd, Banqiao District, New Taipei City',
    address_zh: '新北市板橋區中山路一段200號',
  ...
  },
  {
    ...
    address_en: 'No. 300, Section 3, Taiwan Blvd, Xitun District, Taichung City',
    address_zh: '台中市西屯區台灣大道三段300號',
  ...
  },
  {
    ...
    address_en: 'No. 400, Zhongzheng Rd, West Central District, Tainan City',
    address_zh: '台南市中西區中正路400號',
  ...
  },
  {
    ...
    address_en: 'No. 298, Guangxi Rd, Zhongxiao Village, Cianjhen District, Kaohsiung City',
    address_zh: '高雄市前鎮區忠孝里廣西路298號',
  ...
  },
  {
    ...
    address_en: 'No. 600, Zhonghua Rd, Zhongli District, Taoyuan City',
    address_zh: '桃園市中壢區中華路600號',
  ...
  },
  {
    ...
    address_en: 'No. 700, Guangfu Rd, East District, Hsinchu City',
    address_zh: '新竹市東區光復路700號',
  ...
  },
  {
    ...
    address_en: 'No. 900, Wenhua Rd, West District, Chiayi City',
    address_zh: '嘉義市西區文化路900號',
  ...
  },
  {
    ...
    address_en: 'No. 1000, Zhongxing Rd, Taitung City',
    address_zh: '台東市中興路1000號',
  ...
  },
  {
    ...
    address_en: '1F, No. 2, Lane 138, Wenming St, Nanshi Village, Linkou District, New Taipei City 244',
    address_zh: '244台灣新北市林口區南勢里文明街138巷2號1樓',
  ...
  },
  {
    ...
    address_en: 'No. 15, Alley 11, Lane 158, Guoqing Rd, Chongqing Village, Banqiao District, New Taipei City 220',
    address_zh: '220台灣新北市板橋區重慶里國慶路158巷11弄15號',
  ...
  },
  {
    ...
    address_en: 'No. 52, Jianmei Rd, Fenggong Village, East District, Hsinchu City 300',
    address_zh: '300台灣新竹市東區豐功里建美路52號',
  ...
  },
  {
    ...
    address_en: 'No. 45, Jianmei Rd, Fenggong Village, East District, Hsinchu City 300',
    address_zh: '300台灣新竹市東區豐功里建美路45號',
    latitude: 24.801752, longitude: 120.997791,
    image_link: img(18),
  },
  {
    ...
    address_en: 'No. 19, Xinyi 2nd St, Nanshe Village, Qingshui District, Taichung City 436',
    address_zh: '436台灣臺中市清水區南社里信義二街19號',
  ...
  },
  {
    ...
    address_en: 'No. 151-163, Renyi St, Jiangchuan Village, South District, Taichung City 402',
    address_zh: '402台灣臺中市南區江川里仁義街151-163號',
  ...
  },
  {
    ...
    address_en: 'No. 22-5, Jiangong Ln, Jungong Village, Beitun District, Taichung City 406',
    address_zh: '406台灣臺中市北屯區軍功里建功巷22-5號',
  ...
  },
  {
    ...
    address_en: '1F, No. 73-1, Shifu Rd, Gongyuan Village, Central District, Taichung City 400',
    address_zh: '400台灣臺中市中區公園里市府路73-1號1樓',
  ...
  },
  {
    ...
    address_en: 'No. 6, Chongwen St, Wugong Village, Puli Township, Nantou County 545',
    address_zh: '545台灣南投縣埔里鎮蜈蚣里崇文街6號',
  ...
  },
  {
    ...
    address_en: 'No. 1135, Zhonghua Rd, Damei Village, Zhubei City, Hsinchu County 302',
    address_zh: '302台灣新竹縣竹北市大眉里中華路1135號',
  ...
  },
  {
    ...
    address_en: 'No. 16, Gonghou St, West Central District, Tainan City 70053',
    address_zh: '70053台灣臺南市中西區宮後街16號',
  ...
  },
  {
    ...
    address_en: 'No. 8, Lane 27, Section 4, Guohua St, Liren Village, North District, Tainan City 704003',
    address_zh: '704003台灣臺南市北區立人里國華街四段27巷8號',
  ...
  },
  {
    ...
    address_en: 'No. 35-2, Sanmin St, Guowei Village, Hualien City, Hualien County 970',
    address_zh: '970台灣花蓮縣花蓮市國威里三民街35-2號',
  ...
  },
  {
    ...
    address_en: 'No. 25-3, Yihe St, Wanggong Village, Xinying District, Tainan City 730',
    address_zh: '730台灣臺南市新營區王公里義和街25-3號',
  ...
  },
  {
    ...
    address_en: 'No. 99-1, Baihe District, Tainan City 732',
    address_zh: '732台灣臺南市白河區99之1號',
  ...
  },
  {
    ...
    address_en: 'PC53+VJ, Beixi Village, Huwei Township, Yunlin County',
    address_zh: '台灣雲林縣虎尾鎮PC53+VJ 北溪里',
  ...
  },
  {
    ...
    address_en: "No. 252, Section 2, Keelung Rd, Da'an District, Taipei City",
    address_zh: '台北市大安區基隆路二段252號',
  ...
  },
  {
    ...
    address_en: 'No. 292, Zhongyang Rd, Hsinchu City',
    address_zh: '新竹市中央路292號',
...
export const menuItems: MenuItem[] = [
  // Cashew Flower Raw Food Cuisine (restaurant_id: 1)
  {
    ...
    name_en: 'Matcha Nut Cake', name_zh: '山丘上的茶茶',
    description_en: 'Cashews, Integrated Nuts, Matcha, Longan, Soy Milk, Coconut Oil, Rohan Fructose, Salt, Pepper',
    description_zh: '腰果,綜合堅果,抹茶,桂圓,豆漿,椰子油,羅漢果糖苷,鹽,胡椒',
    dietary_tags: ['gluten-free', 'vegan'],
  },
  {
    id: 2, restaurant_id: 1,
    name_en: 'Chocolate Coffee Nut Cake', name_zh: '堅果可啡',
    description_en: 'Cashews, Integrated Nuts, Coffee, Cocoa, Soy Milk, Coconut Oil, Rohan Fructose, Salt, Pepper',
    description_zh: '腰果,綜合堅果,咖啡,可可,豆漿,椰子油,羅漢果糖苷,鹽,胡椒',
    dietary_tags: ['gluten-free', 'vegan'],
  },
  {
    id: 3, restaurant_id: 1,
    name_en: 'Apple Pie', name_zh: '杏福蘋安派',
    description_en: 'Apple, rhamnoside, coconut milk, cinnamon, ginger, lemon juice, clarified cream, rice flour, almond flour, tree potato flour',
    description_zh: '蘋果,羅漢果糖苷,椰奶,肉桂,薑,檸檬汁,澄清奶油,米穀粉,杏仁粉,樹薯粉',
    dietary_tags: ['gluten-free', 'vegan'],
  },
  ...
  // Yuli Your Home (restaurant_id: 5)
  {
    ...
    name_en: 'Kombu Seaweed pot', name_zh: '昆布鮮蔬鍋',
    description_en: 'A light and refreshing kombu broth slowly simmered with seaweed and vegetables, offering a naturally rich umami flavor that are both clean and comforting',
    description_zh: '以昆布與鮮蔬慢火熬煮，湯頭清甜鮮美，散發天然海味與濃郁旨味，口感清爽無負擔',
    dietary_tags: ['gluten-free'],
  },
  {
    id: 14, restaurant_id: 5,
    name_en: 'Miso pot', name_zh: '日式味噌鍋',
    description_en: 'Crafted with premium Japanese miso, this savory broth delivers a smooth balance of sweetness and umami, perfect for enhancing the natural flavors of meats and vegetables',
    description_zh: '嚴選日式味噌調製，湯底濃郁醇厚，鹹香中帶有自然甘甜，完美襯托肉品與蔬菜的鮮美',
    dietary_tags: ['gluten-free'],
  },
  {
    id: 15, restaurant_id: 5,
    name_en: 'Nut Almond Milk', name_zh: '堅果杏仁奶鍋',
    description_en: 'A velvety broth made with almond milk and blended nuts, creating a creamy, nutty aroma with a delicate sweetness for a uniquely comforting hot pot experience',
    description_zh: '以杏仁奶與堅果調製而成，湯頭滑順香濃，散發自然堅果香氣與淡雅甜味，帶來溫潤細緻的鍋物享受',
    dietary_tags: ['gluten-free'],
  },
  ...
  // Safudou (restaurant_id: 6)
  {
    ...
    name_en: 'Pan-Seared Chicken Thigh', name_zh: '香煎雞腿排',
    description_en: 'Juicy chicken thigh pan-seared until golden brown, seasoned with herbs and spices. Naturally gluten-free when prepared without soy sauce containing wheat',
    description_zh: '嚴選去骨雞腿，以香草及天然香料調味，煎至外皮金黃酥脆、肉質鮮嫩多汁，是一道簡單卻充滿風味的無麩質料理',
    dietary_tags: ['gluten-free'],
  },
  {
    id: 17, restaurant_id: 6,
    name_en: 'Steamed Sea Bass', name_zh: '清蒸鱸魚',
    description_en: 'Fresh sea bass gently steamed with ginger and scallions to preserve its delicate flavor. A light, healthy gluten-free choice',
    description_zh: '新鮮鱸魚搭配薑絲與蔥段清蒸，完整保留魚肉鮮甜與細緻口感，清爽健康且天然無麩質',
    dietary_tags: ['gluten-free'],
  },
  {
    id: 18, restaurant_id: 6,
    name_en: 'Garlic Seasonal Vegetables', name_zh: '蒜香炒時蔬',
    description_en: 'Crisp seasonal vegetables stir-fried with fresh garlic, highlighting their natural sweetness and vibrant colors. Gluten-free with gluten-free seasoning',
    description_zh: '嚴選當季新鮮蔬菜，以蒜香快炒，保留蔬菜爽脆口感與自然鮮甜，是健康又美味的無麩質選擇',
    dietary_tags: ['gluten-free'],
  },
